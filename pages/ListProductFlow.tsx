                                        ...
                                        {experience.map((exp, idx) => (
                                            <div key={idx} className="p-8 bg-gray-50 rounded-[2rem] border border-gray-100 space-y-4 relative group">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <input type="text" onFocus={(e) => e.target.type = 'date'} onBlur={(e) => e.target.type = e.target.value ? 'date' : 'text'} value={exp.startDate} onChange={(e) => updateExp(idx, 'startDate', e.target.value)} placeholder="Start Date" className="bg-white border-none rounded-xl px-4 py-3 font-bold text-[#040457] outline-none w-full" />
                                                    <input type="text" onFocus={(e) => e.target.type = 'date'} onBlur={(e) => e.target.type = e.target.value ? 'date' : 'text'} value={exp.endDate} onChange={(e) => updateExp(idx, 'endDate', e.target.value)} placeholder="End Date" className="bg-white border-none rounded-xl px-4 py-3 font-bold text-[#040457] outline-none w-full" />
                                                </div>
                                        ...
                                        {education.map((edu, idx) => (
                                            <div key={idx} className="p-8 bg-gray-50 rounded-[2rem] border border-gray-100 space-y-4 relative group">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <input type="text" onFocus={(e) => e.target.type = 'date'} onBlur={(e) => e.target.type = e.target.value ? 'date' : 'text'} value={edu.startDate} onChange={(e) => updateEdu(idx, 'startDate', e.target.value)} placeholder="Start Date" className="bg-white border-none rounded-xl px-4 py-3 font-bold text-[#040457] outline-none w-full" />
                                                    <input type="text" onFocus={(e) => e.target.type = 'date'} onBlur={(e) => e.target.type = e.target.value ? 'date' : 'text'} value={edu.endDate} onChange={(e) => updateEdu(idx, 'endDate', e.target.value)} placeholder="End Date" className="bg-white border-none rounded-xl px-4 py-3 font-bold text-[#040457] outline-none w-full" />
                                                </div>
                                            </div>
                                        ))}
                                    </div>
