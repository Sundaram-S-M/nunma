                ...
                <main className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                                        ...
                                        {experience.map((exp, idx) => (
                                            <div key={idx} className="p-8 bg-gray-50 rounded-[2rem] border border-gray-100 space-y-4 relative group">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <input type="text" max="2099-12-31" onFocus={(e) => e.target.type = 'date'} onBlur={(e) => e.target.type = e.target.value ? 'date' : 'text'} value={exp.startDate} onChange={(e) => updateExp(idx, 'startDate', e.target.value)} placeholder="Start Date" className="bg-white border-none rounded-xl px-4 py-3 font-bold text-nunma-forest outline-none w-full" />
                                                    <div className="flex flex-col gap-2 w-full">
                                                        <input type="text" max="2099-12-31" onFocus={(e) => { if (exp.endDate !== 'Present') e.target.type = 'date' }} onBlur={(e) => e.target.type = (e.target.value && e.target.value !== 'Present') ? 'date' : 'text'} value={exp.endDate === 'Present' ? '' : exp.endDate} disabled={exp.endDate === 'Present'} onChange={(e) => updateExp(idx, 'endDate', e.target.value)} placeholder="End Date" className="bg-white border-none rounded-xl px-4 py-3 font-bold text-nunma-forest outline-none w-full disabled:opacity-50 disabled:cursor-not-allowed" />
                                        ...
                                        {education.map((edu, idx) => (
                                            <div key={idx} className="p-8 bg-gray-50 rounded-[2rem] border border-gray-100 space-y-4 relative group">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <input type="text" max="2099-12-31" onFocus={(e) => e.target.type = 'date'} onBlur={(e) => e.target.type = e.target.value ? 'date' : 'text'} value={edu.startDate} onChange={(e) => updateEdu(idx, 'startDate', e.target.value)} placeholder="Start Date" className="bg-white border-none rounded-xl px-4 py-3 font-bold text-nunma-forest outline-none w-full" />
                                                    <input type="text" max="2099-12-31" onFocus={(e) => e.target.type = 'date'} onBlur={(e) => e.target.type = e.target.value ? 'date' : 'text'} value={edu.endDate} onChange={(e) => updateEdu(idx, 'endDate', e.target.value)} placeholder="End Date" className="bg-white border-none rounded-xl px-4 py-3 font-bold text-nunma-forest outline-none w-full" />
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                    ...
                    {step === 3 && (
                        <div className="space-y-12">
                            ...
                            <div className="bg-transparent md:bg-white p-0 py-4 md:p-12 md:rounded-[3.5rem] border-none md:border md:border-gray-100 md:shadow-[0_40px_100px_rgba(0,0,0,0.02)] space-y-10">
                                {/* Type Selector */}
                                <div>
