  ...
  return (
    <div className="space-y-12 max-w-[1600px] mx-auto animate-in fade-in duration-700 pb-20 pr-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        ...
        <div className="bg-[#c1e60d] px-8 py-4 rounded-[2rem] shadow-xl shadow-[#c1e60d]/20 flex items-center gap-4 border-4 border-white">
           <div className="w-12 h-12 rounded-2xl bg-indigo-900 flex items-center justify-center text-white">
              <Zap size={24} fill="#c1e60d" className="text-[#c1e60d]" />
           </div>
           <div>
           ...
           <div className="bg-white rounded-[3rem] w-full max-w-md shadow-2xl overflow-hidden animate-in zoom-in-95 duration-500">
              ...
              <div className="p-10 space-y-4">
                 {topStudents.map(student => (
                   <div key={student.rank} className={`p-5 rounded-2xl flex items-center justify-between ${student.isMe ? 'bg-[#c1e60d]/20 border-2 border-[#c1e60d]' : 'bg-gray-50 border border-gray-100'}`}>
                      <div className="flex items-center gap-4">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-10 items-start">
        <div className="xl:col-span-8 space-y-10">
          <div className="bg-white rounded-[4rem] p-14 border border-gray-100 shadow-2xl relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                {enrolledZones.map(zone => (
                  <div 
                    ...
                    className="group bg-gray-50/50 rounded-[3rem] border border-gray-100 p-8 hover:bg-white hover:shadow-2xl hover:border-[#c1e60d] transition-all duration-700 cursor-pointer"
                  >
                    <div className="h-48 rounded-[2rem] overflow-hidden mb-8 relative shadow-lg">
                      ...
                      <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-md px-3 py-1.5 rounded-xl text-[9px] font-black text-indigo-900 flex items-center gap-1">
                         <Star size={12} fill="#c1e60d" className="text-[#c1e60d]" /> {zone.rating}
                      </div>
                    </div>
                    <div>
                    ...
                    <div className="flex items-center justify-between mt-auto pt-6 border-t border-gray-100">
                      ...
                      <div className="p-4 bg-indigo-900 rounded-2xl shadow-xl shadow-indigo-900/10 text-white group-hover:bg-[#c1e60d] group-hover:text-indigo-900 transition-all active:scale-90">
                        <ArrowRight size={20} />
                      </div>
                    </div>
                  </div>
            ...
            <div className="absolute -bottom-20 -right-20 w-80 h-80 bg-[#c1e60d]/5 rounded-full blur-3xl"></div>
          </div>
          ...
          <div className="bg-[#1A1A4E] rounded-[4rem] p-14 text-white border border-white/5 relative overflow-hidden group">
              <div className="flex items-center justify-between mb-14 relative z-10">
                 <div className="flex items-center gap-5">
                    <Award size={32} className="text-[#c1e60d]" />
                    <h3 className="text-3xl font-black tracking-tighter">Proof of Work Gallery</h3>
                 </div>
                 <button className="px-6 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl text-[10px] font-black text-[#c1e60d] uppercase tracking-[0.2em] transition-all">View Full Portfolio</button>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 relative z-10">
                 ...
                 <div className="aspect-[4/3] bg-white/5 border border-white/10 rounded-[3rem] p-10 flex flex-col justify-between group-hover:bg-white/10 transition-all relative overflow-hidden">
                    <div className="flex justify-between items-start">
                       <div className="w-16 h-16 bg-[#c1e60d] text-indigo-900 rounded-3xl flex items-center justify-center shadow-2xl shadow-[#c1e60d]/20">
                          <Award size={32} />
                       </div>
                    ...
                    <div>
                       ...
                       <p className="text-[10px] font-black text-[#c1e60d] uppercase tracking-widest">Issued: Dec 20, 2025</p>
                    </div>
                    <div className="flex gap-4">
                       ...
                       <button className="flex-1 py-4 bg-[#c1e60d] text-indigo-900 rounded-2xl text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all shadow-lg">
        ...
        <div className="xl:col-span-4 space-y-10">
          <div className="bg-[#1A1A4E] rounded-[3.5rem] p-10 text-white shadow-2xl relative overflow-hidden">
             <div className="flex items-center justify-between mb-10 relative z-10">
                ...
                <button className="text-[10px] font-black text-[#c1e60d] uppercase tracking-widest px-4 py-2 bg-white/5 rounded-xl">Search</button>
             </div>
             <div className="space-y-4 relative z-10">
                <div className="flex items-center gap-5 p-6 bg-white/5 border border-white/5 rounded-[2.5rem] hover:bg-white/10 transition-all cursor-pointer">
                   ...
                   <div>
                      ...
                      <p className="text-[10px] font-black text-[#c1e60d] uppercase tracking-widest mt-1">Lead Product Architect</p>
                   </div>
                </div>
             </div>
          </div>
          ...
          <div className="bg-white rounded-[3.5rem] p-10 border border-gray-100 shadow-xl relative overflow-hidden group">
             ...
             <div className="mt-10 pt-8 border-t border-gray-100 flex items-center justify-between">
                <div className="flex items-center gap-3">
                   <Star size={20} fill="#c1e60d" className="text-[#c1e60d]" />
                   <span className="text-sm font-black text-indigo-900">1,240 XP</span>
                </div>
                <button 
                  onClick={() => setShowLeaderboard(true)}
                  className="text-[10px] font-black text-indigo-900 bg-[#c1e60d] px-6 py-3 rounded-2xl uppercase tracking-widest shadow-lg shadow-[#c1e60d]/20 active:scale-95 transition-all"
                >
                  Leaderboard
                </button>
             </div>
          ...
          <div className="bg-indigo-900 rounded-[3.5rem] p-10 text-white relative overflow-hidden shadow-2xl">
             <div className="relative z-10">
                <Trophy size={56} className="text-[#c1e60d] mb-8" />
                ...
                <button className="w-full py-5 bg-[#c1e60d] text-indigo-900 rounded-3xl font-black uppercase text-[11px] tracking-[0.25em] shadow-xl hover:brightness-110 active:scale-95 transition-all border-4 border-white/10">
