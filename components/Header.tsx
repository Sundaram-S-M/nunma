...
const Header: React.FC<HeaderProps> = ({ onToggleRole }) => {
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-50 flex items-center justify-between px-6 md:px-10 sticky top-0 z-30">
      ...
      <div className="relative">
        <button 
          ...
          className="w-10 h-10 rounded-full border-2 border-white shadow-sm flex items-center justify-center overflow-hidden hover:ring-2 hover:ring-[#c1e60d] transition-all ring-offset-2"
        >
              ...
              <div className="px-6 py-4 border-t border-gray-50 mt-4">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button 
                    ...
                    className={`w-10 h-5 rounded-full p-0.5 transition-colors duration-300 shadow-inner ${user.role === UserRole.TUTOR ? 'bg-[#c1e60d]' : 'bg-gray-200'}`}
                  >
