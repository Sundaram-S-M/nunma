...
const LiveNotification: React.FC = () => {
    ...
    return (
        <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-[200] w-full max-w-xl px-6 animate-in slide-in-from-bottom-10 duration-700">
            <div className="bg-nunma-forest rounded-3xl border border-white/10 shadow-[0_40px_100px_rgba(0,0,0,0.5)] p-6 flex items-center justify-between gap-6 backdrop-blur-xl">
                <div className="flex items-center gap-5">
                    <div className="w-14 h-14 bg-[#c2f575] rounded-2xl flex items-center justify-center animate-pulse shadow-[0_0_30px_rgba(194,245,117,0.2)]">
                        <Radio size={28} className="text-nunma-forest" />
                    </div>
                    <div>
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        className="px-6 py-4 bg-[#c2f575] text-nunma-forest rounded-2xl font-black uppercase text-[10px] tracking-widest flex items-center gap-3 hover:scale-105 active:scale-95 transition-all shadow-xl"
                    >
